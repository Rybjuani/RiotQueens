...
Un proveedor/configuración pasa cuando completa el glosario sin bloqueos indebidos de voz, sin fuga de identidad y con límites preservados. El resultado debe registrar modelo, proveedor, parámetros, commit, fecha y muestra de salida sanitizada. Este resultado sólo habilita a Bardera.
