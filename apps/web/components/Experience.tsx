    ...
    <section className="experience" id="experience">
      ...
      <div className="experience-grid">
        <article className="experience-photo">
          ...
          <img src="/queens/img-065-reference.jpg" alt="Retrato de cuerpo completo de La Bardera" width={1664} height={2432} loading="lazy" decoding="async" />
      ...
      <div className="narrative-card">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/queens/img-074-support.jpg" alt="La Bardera en una terraza al atardecer" width={1536} height={2688} loading="lazy" decoding="async" />
      </div>
    </section>
  );
}
